---
title: Installation
description: Learn how to get started using Ori in your app.
---

Welcome to Ori UI, a collection of headless component primitives for Svelte 5 that prioritizes developer experience, accessibility, and flexibility. This guide will help you quickly integrate Ori UI into your Svelte application.
...
After installation, you can import and use Ori UI components in your Svelte files. Here's a simple example using the [Accordion](/docs/components/accordion) component.
...
Ori UI components are headless by design, meaning they ship with minimal styling. This gives you complete control over the appearance of your components. Each component that renders an HTML element exposes a `class` prop and `style` prop that you can use to apply styles to the element.
...
Each Ori UI component applies specific data attributes to the underlying HTML elements. You can use these attributes to target components in your global styles:
...
Ori UI is built with TypeScript and provides comprehensive type definitions. When using TypeScript, you'll get full type checking and autocompletion:
...
Now that you have Ori UI installed and working, you can:
...
- Learn how Ori UI handles [State Management](/docs/state-management) and how you can take more control over your components

## Resources

If you have questions or need help, there are several ways to get support from the Ori UI community:

- For confirmed bugs, please [open an issue](https://github.com/huntabyte/bits-ui/issues) on GitHub.
- Have a question or need help? Join our [Discord community](https://discord.gg/fdXy3Sk8Gq) or [open a discussion](https://github.com/huntabyte/bits-ui/discussions/new) on GitHub to chat with other developers and the Ori UI team.
