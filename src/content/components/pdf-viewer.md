...
<CodePreview>
    <PdfViewer.Root src="https://pdfobject.com/pdf/sample.pdf" class="flex flex-col gap-4 w-full h-[600px] bg-muted/20 rounded-lg p-4">
        <PdfViewer.Toolbar />
        <PdfViewer.Renderer class="flex-1 bg-background/50 rounded-md border" />
    </PdfViewer.Root>
</CodePreview>
...
<PdfViewer.Root src="/path/to/document.pdf" class="flex flex-col gap-4">
	<PdfViewer.Toolbar />
	<PdfViewer.Renderer class="min-h-125" />
</PdfViewer.Root>
```
